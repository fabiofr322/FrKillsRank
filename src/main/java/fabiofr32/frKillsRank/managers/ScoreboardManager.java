...
public class ScoreboardManager {
        ...
        public static void updateScoreboard(Player player) {
            // Verifica se o scoreboard está ativado na configuração
            if (!FrKillsRank.getInstance().getConfig().getBoolean("settings.scoreboard.enabled", true)) {
                clearScoreboard(player); // Limpa o scoreboard se estiver desativado
                return;
            }
